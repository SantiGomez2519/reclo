                                ...
                                <tbody>
                                    @foreach($viewData['customUsers'] as $user)
                                        <tr>
                                            ...
                                            <td>{{ $user->getPhone() }}</td>
                                            <td>
                                                <span class="badge bg-info">{{ __('admin.payment_' . str_replace(' ', '_', strtolower($user->getPaymentMethod()))) }}</span>
                                            </td>
                                            <td>
                                                <span class="badge bg-secondary">{{ $user->getProducts()->count() }}</span>
                                            </td>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <a href="{{ route('admin.customusers.edit', $user->getId()) }}" 
                                                     ...
                                                     <form method="POST" action="{{ route('admin.customusers.destroy', $user->getId()) }}" class="d-inline">
                                                         @csrf
                                                         @method('DELETE')
