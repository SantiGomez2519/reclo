        ...
        <div class="col-md-10">
            <div class="card admin-card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="{{ route('admin.products.edit', $viewData['product']->getId()) }}" class="btn btn-warning me-2">
                        ...
                        <div class="col-md-4">
                            @if($viewData['product']->getImage())
                                <div class="product-image-container position-relative">
                                    ...
                                    <div class="text-center p-5 bg-light rounded shadow-sm image-fallback-container">
                                        <i class="fas fa-image fa-3x text-muted"></i>
                                        <p class="text-muted mt-2">{{ __('admin.image_not_found') }}</p>
                                    </div>
                                </div>
                            @else
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <p class="mb-1">
                                            <span class="badge bg-primary">{{ __('admin.category_' . $viewData['product']->getCategory()) }}</span>
                                        </p>
                                    </div>

                                    <div class="mb-3">
                                        <strong class="text-muted">{{ __('admin.price') }}:</strong>
                                        <p class="mb-1 fs-5 fw-bold text-success">${{ number_format($viewData['product']->getPrice()) }}</p>
                                    </div>

                                    <div class="mb-3">
                                        <strong class="text-muted">{{ __('admin.status') }}:</strong>
                                        <p class="mb-1">
                                            <span class="badge {{ $viewData['product']->getStatus() === 'available' ? 'bg-success' : ($viewData['product']->getStatus() === 'sold' ? 'bg-danger' : 'bg-warning') }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <p class="mb-1">
                                            <span class="badge bg-info">{{ __('admin.condition_' . $viewData['product']->getCondition()) }}</span>
                                        </p>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <p class="mb-1">
                                            <span class="badge {{ $viewData['product']->getSwap() ? 'bg-success' : 'bg-secondary' }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <p class="mb-1">{{ date('M d, Y H:i', strtotime($viewData['product']->getCreatedAt())) }}</p>
                                    </div>

                                    <div class="mb-3">
                                        <strong class="text-muted">{{ __('admin.last_updated') }}:</strong>
                                        <p class="mb-1">{{ date('M d, Y H:i', strtotime($viewData['product']->getUpdatedAt())) }}</p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <p class="mb-1">
                                                <span class="badge bg-info">{{ __('admin.payment_' . str_replace(' ', '_', strtolower($viewData['product']->seller->getPaymentMethod()))) }}</span>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="mt-2">
