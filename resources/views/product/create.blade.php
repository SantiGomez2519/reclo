...
@section('title', 'Create Product - Reclo')

@section('content')
    <div class="container mx-auto px-4 py-8 max-w-2xl">
        <!-- Header -->
        <div class="text-center mb-8">
            <h1 class="text-3xl font-bold text-gray-800 mb-2">List Your Items</h1>
            <p class="text-gray-600">Upload photos and details of your pre-loved fashion pieces</p>
        </div>
            ...
            <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    <label class="flex items-center">
                        <input type="checkbox" name="swap" value="1" {{ old('swap') ? 'checked' : '' }}
